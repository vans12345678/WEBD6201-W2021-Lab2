...
(function(){
    ...
    function toggleLogin()
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            ...
            $("#navLogin").html(
                `<a class="nav-link" aria-current="page" href="#"><i id="navUser"class="fas fa-user-alt fa-lg"></i></a>`
            );

            let navTextElement = document.getElementById("navLogout").innerHTML = ` Logout`;
            ...
            // $(`<li class="nav-item">
            // <a class="nav-link" aria-current="page" ><i class="fas fa-users fa-lg"></i>user</a>
