...
(function(){
    ...
    function toggleLogin()
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            ...
            $("#aLogin").html(
                `<a id="navLogout" class="nav-link" aria-current="page" href="#"><i class="fas fa-sign-out-alt fa-lg"></i></a>`
            );

            let navTextElement = document.getElementById("navLogin").textContent = " Logout";
