...
(function(){
    ...
    function DisplayNav()
    {
        ...
        navTextElement = document.getElementById("navLogin").innerHTML = `<a  class="nav-link fa-lg active" aria-current="page" href="login.html"><i class = "fas fa-map fa-sm"></i>Login</a>`;
